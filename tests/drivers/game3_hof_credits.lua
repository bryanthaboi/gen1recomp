...
local function run(game)
  ...
  U.shot(game, DIR .. "/cred_hof_first_mon.png")
  ...
  U.shot(game, DIR .. "/cred_hof_player_card.png")
  U.tap(game, "a")
  ...
  U.wait(20)
  U.shot(game, DIR .. "/cred_title_staff.png")
  ...
  U.shot(game, DIR .. "/cred_text_page.png")
  ...
  U.shot(game, DIR .. "/cred_map_scene_runner.png")
  ...
  U.wait(30)
  U.shot(game, DIR .. "/cred_mon_scene.png")
  ...
  U.wait(20)
  U.shot(game, DIR .. "/cred_the_end.png")
  ...
  U.wait(600)
  U.shot(game, DIR .. "/cred_back_at_title.png")
end
